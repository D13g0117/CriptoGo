...
public class RealizarAccionPlan extends Plan
{
	public void body()
	{
        ...
        IMessageEvent informe = createMessageEvent("Inform_Realizando_Accion");
        RealizandoAccion predicado = new RealizandoAccion();
